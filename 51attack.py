network_hashrate= 193 * 10**18 # (H/s) 193 EH/s (all-time-high network hashrate)
...
hardware_cost_1HS = 5000 / 10**14 # cost of 1 H/s. Based on consumer price antminer s19j => rounded to 100TH/s for $5000(3KWh)
...
def main():
    hardware_cost = total_attacker_hashrate * hardware_cost_1HS
